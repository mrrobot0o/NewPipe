...
configure<ApplicationExtension> {
    ...
    defaultConfig {
        ...
        resValue("string", "app_name", "Teresa")
        minSdk = 21
        targetSdk = 35
    ...
    buildTypes {
        debug {
            ...
            if (normalizedWorkingBranch.isEmpty() || workingBranch in defaultBranches) {
                ...
                resValue("string", "app_name", "Teresa Debug")
            } else {
                applicationIdSuffix = ".debug.$normalizedWorkingBranch"
                resValue("string", "app_name", "Teresa $workingBranch")
            }
        }
        ...
        release {
            System.getProperty("packageSuffix")?.let { suffix ->
                ...
                resValue("string", "app_name", "Teresa $suffix")
            }
